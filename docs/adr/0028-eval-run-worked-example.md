...
- Example repository: [`npstorey/typedstandards-eval-run-example`](https://github.com/npstorey/typedstandards-eval-run-example), public since 2026-09-20; commits `d5fc615`…`9031a94`, all signed. A fresh clone plus `npm ci && node verify.mjs` exits 0 with zero network calls. Verify output: `docs/verify-output.txt`. Phase records: `docs/p0-record.md`…`docs/p4-record.md`; the frozen formula is `docs/p2-preregistration.md`.
