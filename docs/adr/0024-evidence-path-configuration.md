...
- **Status:** **Proposed** 2026-08-12 (drafted the day the third instance of the class was verified; acceptance is a maintainer-review flip, per the ADR-0022/0023 precedent)
- **Date:** 2026-08-12
...
- **[civic-ai-tools#129](https://github.com/npstorey/civic-ai-tools/issues/129) is the open instance of the class**, and closes under §A/§B by requiring `model` or omitting it — not by a fresher slug. The eleven affected records are accurate; no remediation is proposed, and none is implied by this ADR.
