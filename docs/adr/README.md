...
| [0030](0030-self-certifying-signer-did-key.md) | A self-certifying signer for the `pseudonymous` rung — a `did:key` identifier derived from the signing key, checked with no registry, and the trust status `self_certified` | Proposed (2026-09-21) |
