...
**Context addendum (2026-07-01, recorded from the chat-history extraction evaluation).** Two rename drivers from the 2026-05 working sessions were part of the decision but not captured above: (1) the prior "Open Evidence Standard" name collided with an established, well-funded medical-AI product of essentially the same name — an SEO/disambiguation losing battle for a new standard; (2) the work had outgrown both "civic" and "AI-assisted analysis" as identity terms — the envelope is content- and producer-agnostic. (A third chat-era framing, "CCV becomes the Typed Claims Profile," did not survive into the repo as stated: CCV's content consolidated into spec §8.11 "Typed Claims," while "Typed Claims Profile" remains the distinct content-profile-axis concept of [ADR-0006](0006-producer-profile-architecture.md).)
