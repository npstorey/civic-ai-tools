...
**Which checks test these.** Requirements 1 and 2 are §9.2 check #15. Requirements 4 and 5 are checks #3 and #4. Requirement 6 is check #16. Requirements 3, 7 and 8 are producer obligations that no v0.1 check tests, as the §8.7.1 requirements for `datHere` are.
