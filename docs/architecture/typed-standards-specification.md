...
Version: v0.1.9
Tag: v0.1.9-typed-standards-spec
License: CC BY 4.0
...
**Status:** v0.1 Working Draft — open for external review (review window to be scheduled)
**Spec name:** Typed Standards Specification
**Version:** v0.1.9 (patch revision of the v0.1 Working Draft; tag: `v0.1.9-typed-standards-spec`)
