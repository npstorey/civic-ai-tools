...
- [`chat-type-taxonomy.md`](chat-type-taxonomy.md) — the conversation-surface discipline. Defines the eight project-specific chat types, their proper uses, and the closure rules that hold them apart. Companion doctrine to this method and to `xanadu-doctrine.md`.
