...
```mermaid
flowchart LR
    P["🎭 Pseudonymous<br/>self-generated keypair<br/>no external binding<br/>(self-certifying did:key form: ADR-0030)"]:::designed
