...
- **Stakes.** OES spec versioning discipline; downstream consumer-pinning ergonomics; coordination with the Pittsburgh arc cohort of changes (datHere via ADR-0004, executed-notebook via ADR-0005, then anticipated ADRs for the unified primitive, visibility lifecycle via [civic-ai-tools#71](https://github.com/npstorey/civic-ai-tools/issues/71), and attestations via [civic-ai-tools#70](https://github.com/npstorey/civic-ai-tools/issues/70)).
