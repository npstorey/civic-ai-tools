...
*Last updated: 2026-07-29 (v14) — intro line edits: transparency-commitments clause; RuleSpec-traceability scoping; "One possible solution" opener; reference implementation folded into attribution. v13 `58b8ea0`; v12 `a5309f1`; v11 `b679e83`; v10 `356550c`; v9 `8acc9f3`; v8 `a8b9472`; v7 `fce0c0a`; v6 `7435fee`; v5.1 `deb9b5c`; v5 `49bcc8d`; v4 archived (`rulespec-interop-poc-v4-archive.md`, `3eeea0e`); v3 `f74ad55`; v2 `60b9345`; v1 `dbe1d2d`.*
