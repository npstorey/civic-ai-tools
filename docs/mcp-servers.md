...
| [nyc-record-mcp](https://github.com/BetaNYC/nyc-record-mcp) | NYC Open Data — City Record Online (dataset dg92-zbpx) | stdio | [@BetaNYC](https://github.com/BetaNYC) | Active | Launched 2026-05-21 by BetaNYC. No required API key (optional SOCRATA_APP_TOKEN for higher rate limits). README credits socrata-mcp-server as inspiration for its SODA API pattern. Published on npm as @betanyc/nyc-record-mcp. |
