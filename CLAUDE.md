...
- [`working-method.md`](docs/architecture/working-method.md) — project discipline governing decision-making: the four surfaces (registry / proposed-issues + GitHub issues / ADRs / specs), the promotion path from question to issue to ADR, and the explicit avoidance of issue-tracker-as-thinking-surface. Companion doctrine to `xanadu-doctrine.md`.
